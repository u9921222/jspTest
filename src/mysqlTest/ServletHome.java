...
//        ArrayList<ArrayList<String>> results = hrDao.getEmployees();
        ...
        if (tag.equals("addEmp")) {
            ...
            if (results != null) {
                ...
                if (results1 != null) {
                    ...
                    String insert_into_leave_stat = "insert into leave_stat(empl_id,leave_type_id,start_dt,end_dt)"
                            + "values (\"" + results1.get(0).get(0) + "\",\"" + results.get(0).get(0) + "\",\""
                            + start_dt + "\",\"" + end_dt + "\")";
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        if (tag == null)
            tag = "";
//// sessionTest
        if (tag.equals("sessionTest")) {
            System.out.println("sessionTest");
            req.getSession().setAttribute("sessionTest","settedAttr");
