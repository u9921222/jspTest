...
public class ServletHome extends HttpServlet {
	...
	public static ArrayList<ArrayList<String>> getEmployees() {
		...
		resultArgs.add("name");
		ArrayList<ArrayList<String>> results = MySQLHelper.MySQLexecuteQuery(selectAll,resultArgs);
		return results;
	}
...
////addEmp
		if (tag.equals("addEmp")) {
			...
			if(MySQLHelper.MySQLexecuteUpdate(insertInto)) {
...
////sentLeave
			...
			ArrayList<ArrayList<String>> results = MySQLHelper.MySQLexecuteQuery(select_leave_type_id, resultArgs);
			if(results != null) {
				...
				ArrayList<ArrayList<String>> results1 = MySQLHelper.MySQLexecuteQuery(select_empl_id, resultArgs1);
				if(results1 != null) {
					...
					if(MySQLHelper.MySQLexecuteUpdate(insert_into_leave_stat)) {
